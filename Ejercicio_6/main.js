...
const totalScores = exams.reduce((acc, student) => acc + student.score, 0);
...
const passingStudents = exams.reduce((acc, student) => {
  if (student.score >= 5) {
...
const averageScore = exams.reduce((acc, student) => acc + student.score, 0) / exams.length;
